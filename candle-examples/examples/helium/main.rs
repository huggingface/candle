// Helium text generation using AutoModelForCausalLM.
...
fn main() -> Result<()> {
    ...
    let model_id = args
        .model_id
        .unwrap_or_else(|| "kyutai/helium-1-preview-2b".to_string());
    ...
    let prompt = args
        .prompt
        .as_deref()
        .unwrap_or("The best thing about Rust is");
