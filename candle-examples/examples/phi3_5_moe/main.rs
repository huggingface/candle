...
use candle_transformers::models::phi3_5moe::{Config, Model};
...
impl TextGeneration {
    ...
    fn run(&mut self, prompt: &str, sample_len: usize) -> Result<()> {
        ...
        for index in 0..sample_len {
            ...
            let logits = self.model.forward(&input, pos, pos + 1)?;
...
fn main() -> Result<()> {
    ...
    let model_id = match args.model_id {
        ...
        None => "microsoft/Phi-3.5-MoE-instruct".to_string(),
    };
