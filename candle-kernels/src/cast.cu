...
CAST_OP(__nv_fp8_e4m3, __nv_fp8_e4m3, cast_f8e4m3_f8e4m3)
...
CAST_OP_FP8(__nv_fp8_e4m3, float,    cast_f8e4m3_f32)
CAST_OP_FP8_INTO(float,    __nv_fp8_e4m3, cast_f32_f8e4m3)
CAST_OP_FP8(__nv_fp8_e4m3, uint8_t, cast_f8e4m3_u8)
CAST_OP_FP8(__nv_fp8_e4m3, __half, cast_f8e4m3_f16)
CAST_OP_FP8(__nv_fp8_e4m3, double,  cast_f8e4m3_f64)
CAST_OP_FP8_INTO(__half,   __nv_fp8_e4m3, cast_f16_f8e4m3)
CAST_OP_FP8_INTO(double,   __nv_fp8_e4m3, cast_f64_f8e4m3)
CAST_OP_FP8_INTO(uint8_t,   __nv_fp8_e4m3, cast_u8_f8e4m3)
CAST_OP_FP8_INTO(int32_t,   __nv_fp8_e4m3, cast_i32_f8e4m3)
CAST_OP_FP8(__nv_fp8_e4m3, int32_t, cast_f8e4m3_i32)
CAST_OP_FP8(__nv_fp8_e4m3, __nv_bfloat16, cast_f8e4m3_bf16)
CAST_OP_FP8_INTO(__nv_bfloat16, __nv_fp8_e4m3, cast_bf16_f8e4m3)
#else
#include <cuda.h>
...
CAST_THROUGH_OP(__nv_bfloat16, __nv_fp8_e4m3, float, cast_bf16_f8e4m3)
#endif
#endif
