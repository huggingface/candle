...
pub enum Functions{UnaryInplaceContiguous,UnaryFromBuffer,UnaryFromBufferContiguous}
impl crate::EntryPoint for Functions{
    fn get_entry_point(&self) -> &'static str{
        match self{
            Functions::UnaryInplaceContiguous => "gah",Functions::UnaryFromBuffer => "gad",Functions::UnaryFromBufferContiguous => "gag"
        }
    } 
}
