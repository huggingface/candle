...
//! Cast operations: TEAM-493 (to_cpu_storage, to_dtype)
...
impl RocmStorage {
    // Created by: TEAM-493 | CUDA parity verified by: TEAM-497 (cuda_backend/mod.rs:1519-1554)
    ...
    // Created by: TEAM-493 | CUDA parity verified by: TEAM-497 (cuda_backend/mod.rs:1349-1470)
    pub(super) fn to_dtype_impl(
        &self,
        layout: &crate::Layout,
        dtype: crate::DType,
    ) -> Result<Self> {
