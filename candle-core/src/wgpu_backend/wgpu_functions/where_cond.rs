...
pub fn queue_where_cond(
    ...
    let pipeline = match cond_type {
        crate::DType::U32 => Pipelines::WhereCond(get_dtype(dtype)?, candle_wgpu_kernels::where_cond::Functions::WhereCondIndexU32),
        crate::DType::I64 => Pipelines::WhereCondi64(get_dtype(dtype)?, candle_wgpu_kernels::where_condi64::Functions::WhereCondIndexI64),
