...
// gelu_erf(x) = 0.5 * x * (1 + erf(x / sqrt(2))). This uses v?Erf rather than v?CdfNorm as the
// latter is known to be very slow on large negative inputs.
// https://github.com/pytorch/pytorch/issues/48388
#[inline]
