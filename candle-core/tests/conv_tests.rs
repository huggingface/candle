...
fn conv2d_c_eq_h_eq_w(dev: &Device) -> Result<()> {
    let t = Tensor::new(
        &[
            1.9269f32, 1.4873, 0.9007, -2.1055, 0.6784, -1.2345, -0.0431, -1.6047, -0.7521,
            ...
            -0.4245, 0.3057, -0.7746, -1.5576, 0.9956, -0.8798, -0.6011, -1.2742, 2.1228,
            -1.2347, -0.4879, -0.9138, -0.6581, 0.0780, 0.5258, -0.4880, 1.1914, -0.8140,
            -0.7360, -1.4032, 0.0360, -0.0635, 0.6756, -0.0978, 1.8446, -1.1845, 1.3835,
        ],
        dev,
    )?;
