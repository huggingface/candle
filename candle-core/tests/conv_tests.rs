...
test_device!(conv1d, conv1d_cpu, conv1d_gpu, conv1d_metal, conv1d_sycl);
test_device!(
    conv1d_small,
    conv1d_small_cpu,
    conv1d_small_gpu,
...
test_device!(conv2d, conv2d_cpu, conv2d_gpu, conv2d_metal, conv2d_sycl);
test_device!(
    conv2d_non_square,
    conv2d_non_square_cpu,
    conv2d_non_square_gpu,
    conv2d_non_square_metal,
    conv2d_non_square_sycl
);
test_device!(
    conv2d_small,
    conv2d_small_cpu,
...
test_device!(
    ...
    conv2d_grad_noncontiguous_kernel_sycl
);
